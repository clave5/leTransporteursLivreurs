...
class ClientExpandedComponent extends StatefulWidget {
  const ClientExpandedComponent({super.key});

  @override
  State<ClientExpandedComponent> createState() => _ClientExpandedComponentState();
}

class _ClientExpandedComponentState extends State<ClientExpandedComponent> {
  @override
