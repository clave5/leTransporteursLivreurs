...
class AssistanceSessionComponent extends StatefulWidget {
  ...
  @override
  State<AssistanceSessionComponent> createState() => _AssistanceSessionComponentState();
}

class _AssistanceSessionComponentState extends State<AssistanceSessionComponent> {
  @override
