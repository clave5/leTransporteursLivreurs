...
class ActiviteComponent extends StatefulWidget {
  const ActiviteComponent({super.key});

  @override
  State<ActiviteComponent> createState() => _ActiviteComponentState();
}

class _ActiviteComponentState extends State<ActiviteComponent> {
  @override
