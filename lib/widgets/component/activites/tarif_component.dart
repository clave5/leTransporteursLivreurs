...
class TarifComponent extends StatefulWidget {
  const TarifComponent({super.key});

  @override
  State<TarifComponent> createState() => TarifComponentState();
}

class TarifComponentState extends State<TarifComponent> {
  @override
